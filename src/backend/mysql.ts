...
export function createConnection() {
    connection.connect((err) => {
        ...
        executeQuery('CREATE TABLE IF NOT EXISTS `schedules` (`id` INT NOT NULL AUTO_INCREMENT, `petName` VARCHAR(64) NOT NULL, `service` VARCHAR(64) NOT NULL, `emailOwner` VARCHAR(64) NOT NULL, `date` DATETIME NOT NULL, `price` DOUBLE NOT NULL, PRIMARY KEY(`id`)) ENGINE = InnoDB DEFAULT CHARSET = UTF8;');
    })
}
