...
const CreateService = () => {
    ...
    return (
        <div className="container mx-auto mt-10 px-4">
            <form onSubmit={handleSubmit} className="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-xl">
                <h2 className="text-2xl font-semibold text-center mb-6">Agendar Serviço</h2>
            ...
            {successMessage && (
                <p className="text-green-600 text-center font-bold mt-4">Serviço agendado com sucesso!</p>
            )}
        </div>
    );
};
